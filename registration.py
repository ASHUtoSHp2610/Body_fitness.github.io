...
btn = tk.Button(window, text="Register", bg="Black",font=("Bold",20),fg="white", width=9, height=0, command = insert)
btn.place(x=150, y=600)

btn1 = tk.Button(window, text="Login", bg="Black",font=("bold",20),fg="white", width=9, height=0, command=login)
btn1.place(x=350, y=600)
